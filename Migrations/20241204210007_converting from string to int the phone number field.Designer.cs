...
namespace Xo_Test.Migrations
{
    ...
    [Migration("20241204210007_converting from string to int the phone number field")]
    partial class convertingfromstringtointthephonenumberfield
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Xo_Test.Models.Phone", b =>
                {
            ...
            modelBuilder.Entity("Xo_Test.Models.SecondaryActivity", b =>
                {
                    b.Property<int>("SecondaryActivityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SecondaryActivityId"));
                    ...
                    b.HasKey("SecondaryActivityId");

                    b.HasIndex("BusinessId");

                    b.ToTable("SecondaryActivity", (string)null);
                });
            ...
            modelBuilder.Entity("Xo_Test.Models.Business", b =>
                {
                    ...
                    b.Navigation("SecondaryActivities");
                });
